...
export default function App() {
  ...
  return (
    <div className="h-screen w-full flex bg-gradient-to-br from-neutral-100 via-white to-neutral-200 dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-950">
      <div className="hidden md:flex md:w-64 md:flex-col border-r border-white/40 bg-white/80 backdrop-blur-md dark:border-neutral-800/70 dark:bg-neutral-900/80 md:sticky md:top-0 md:h-screen">
