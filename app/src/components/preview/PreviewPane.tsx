...
export function PreviewPane() {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {/* Payload row with copy icon */}
      <div className="flex items-center gap-2">
        <div className="flex-1 overflow-x-auto whitespace-nowrap rounded-md border bg-white dark:bg-neutral-900 dark:border-neutral-800 px-2 py-2 font-mono text-xs text-neutral-800 dark:text-neutral-100">
          {payload}
        </div>
        <button
          className="h-9 w-9 inline-flex items-center justify-center rounded-md border bg-white dark:bg-neutral-900 dark:border-neutral-700"
          onClick={copyPayload}
      ...
      {/* QR card */}
      <div className="border rounded-md p-4 bg-white dark:bg-neutral-900 dark:border-neutral-800 self-start">
